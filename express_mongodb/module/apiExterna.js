...
export const mostrarPacientes = async () => {
    const URL = "http://localhost:5262/app/ver/pacientes";
    //const URL = "http://localhost:5262/app/dietas";
    const Headers = {
        method: "GET",
...
export const pacientesAdd = async (pacientes) => {
    try {
        const URL = "http://localhost:5262/app/pacientes/add";
...
export const mostrarProfesionales = async () => {
    const URL = "http://localhost:5262/app/profesionales";
    const Headers = {
        method: "GET",
        headers: { "Content-Type": "application/json" },
    };
...
export const eliminarPacientexrut = async (rut) => {
    try {
        const URL = `http://localhost:5262/app/pacientes/eliminar/${rut}`;
        const Headers = {
            method: "DELETE",
            headers: { "Content-Type": "application/json" },
        };
...
export const ProfesionalesAdd = async (profesionales) => {
    try {
        const URL = "http://localhost:5262/app/profesional/add";
...
export const pacientesEditEstado = async (Rut, Estado) => {
    try {
        const URL = `http://localhost:5262/app/actEstado`;
        const data = {
            Rut, Estado
        };
        const Headers = {
...
export const pacientesEdit = async (Rut, nombre, fechaNac, sexo, edad, peso, descripcion, estado, apellidos, correo, telefono) => {
    try {
        const URL = `http://localhost:5262/app/pacientes/edit`;
        const data = {
            Rut,
            nombre,
            fechaNac,
...
export const dietaEdit = async (Id, nombre, descripcion, categoria) => {
    try {
        const URL = `http://localhost:5262/app/dieta/edit`;
        const data = {
            Id,
            nombre,
            descripcion,
...
export const infoNutriEdit = async (Id, porciones) => {
    try {
        const URL = `http://localhost:5262/app/infonutri/edit`;
        const data = {
            Id,
            porciones
        };
...
export const citasAdd = async (citas) => {
    try {
        const URL = "http://localhost:5262/app/citas/add";
        const data = citas;
        const Headers = {
            method: "POST",
            body: JSON.stringify(data),
...
export const dietasAdd = async (dietas) => {
    try {
        const URL = "http://localhost:5262/app/dietas/add";
        const data = dietas;
        const Headers = {
            method: "POST",
            body: JSON.stringify(data),
...
export const eliminarDietaxid = async (id) => {
    try {
        const URL = `http://localhost:5262/app/dietas/eliminar/${id}`;
        const Headers = {
            method: "DELETE",
            headers: { "Content-Type": "application/json" },
        };
...
export const mostrarIngredientes = async () => {
    const URL = "http://localhost:5262/app/mostrarIngredientes";
    const Headers = {
        method: "GET",
        headers: { "Content-Type": "application/json" },
    };
...
export const ingreEdit = async (id, tipo, nombre) => {
    try {
        const URL = `http://localhost:5262/app/ingre/edit`; 
        const data = {
            id,
            tipo,
            nombre
...
export const profesionalEditEstado = async (Rut, Estado) => {
    try {
        const URL = `http://localhost:5262/app/actEstado/profesional`;
        const data = {
            Rut, Estado
        };
        const Headers = {
...
export const verInfoNutri = async () => {
    const URL = "http://localhost:5262/app/ver/infonutri";
    const Headers = {
        method: "GET",
        headers: { "Content-Type": "application/json" },
    };
...
export const infoNutriAdd = async (infonutri) => {
    try {
        const URL = "http://localhost:5262/app/infonutri/add";
...
export const eliminarxinfonutri = async (id) => {
    try {
        const URL = `http://localhost:5262/app/infonutri/eliminar/${id}`;
        const Headers = {
            method: "DELETE",
            headers: { "Content-Type": "application/json" },
        };
